...
param(
    ...
    #Pricing can be found - https://azure.microsoft.com/en-us/pricing/details/virtual-machines/windows/
    #Suggested max size with $150 free subscription 9/11/2018 - "Standard_D4s_v3"
...
#Datacenter location validity check
